...
const UpdateClient = ({perms,getPerms,updateUser,clientUpdated,location}) =>
{
    ...
    return(
        <div className='addClientPage'>
            {clientUpdated || reroute? <Redirect to="/Clients"/> : null}
            ...
            <div className="createClientBtn" onClick={createClient}>
                <CustomButton btnText="Update Client"/>
            </div>
        </div>
    )
}
...
const mapStateToProps = state =>
{
    return{
        ...
        clientUpdated:state.clients.clientUpdated
    }
}
