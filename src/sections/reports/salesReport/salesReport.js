...
const SalesReport = ({fetchSaleListStart,orderId,getClients,clients,GetClientPricesStart,clientWithPrices,fetchTelecomStart,telcoList,GetVendors,vendors,downloadReport,GetDwnldReport,FetchCategoriesStart,categories,clearDownloadReport}) =>
{

    const [downloadParams,setDownloadParams] = useState({FromDate:null,ToDate:null,categoryId:null,CustomerId:null,productId:null,telCoId:null})
    ...
    return(
        <div className="content">
            ...
            <div className="subHeader-reports">
                <h2 className="subText-reports">Reports/Sales Report</h2>
                ...
                </div>
                {
                    downloadReport ? downloadReport.data.map((report,index)=>
                    {
                        return <div className='reports-vals' key={index}>
                                    ...
                                    <div className='reports-title-val'>{report.avgCost}</div>
                                    <div className='reports-title-val'>{"to yet recieve"}</div>
