...
const SubSection = ({titles,half,quarter,children,manageProd,vouchersTitle,AddProds,viewBatch,ResTitle,newRest}) =>
{
    return(
        <div className="Content" >
            <div className={half ? "subSectionHalf" : quarter ? "subSectionQuarter"  :" subSection" }>
               <div className={manageProd ?  "manageProd-titles" : vouchersTitle ? "voucherstTitle" :  viewBatch ? "vbTitles" : ResTitle ? "ResTitle" :"titles" }>
                    { 
                        titles ?
